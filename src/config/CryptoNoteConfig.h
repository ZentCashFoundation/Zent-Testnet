...
// Copyright (c) 2019-2022, The Zent Cash Developers
//
...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint32_t UPGRADE_HEIGHT_V6 = 1700000; // Upgrade height for Chukwa switch.
        ...
        const uint64_t FORK_HEIGHTS[] = {
            ...
            1700000, // 12 - Upgrade Height V6 Argon2Id Chukwa
    ...
    const char CRYPTONOTE_NAME[] = "Zent-Testnet";
    ...
    const int RPC_DEFAULT_PORT = 20000;

    const int SERVICE_DEFAULT_PORT = 21695;
    ...
    const static boost::uuids::uuid CRYPTONOTE_NETWORK = {
        {0xc1, 0x43, 0xd8, 0x6c, 0xcc, 0x12, 0x42, 0x9c, 0x33, 0xd6, 0x35, 0xa5, 0xee, 0xc1, 0x43, 0xd8}};

    const char *const SEED_NODES[] = {
      	"135.181.149.197:10000",
        "135.181.149.197:10001",
	"135.181.149.197:10002",
    };
} // namespace CryptoNote
